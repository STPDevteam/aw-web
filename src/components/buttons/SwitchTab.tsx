...
export const SwitchTab:React.FC<iSwitchTab> = ({
    ...
    return (
        <Box gap={['4px','4px','4px','4px','8px','10px']} mt="20px" className='fx-row ai-ct jc-sb' w="100%" >
             <Box className={`click center gradient_left_border ${selectedIdx === 0 ? 'selected' : '' }`} w="100%" h="46px" onClick={() => setSelectedIdx(0)}>
                <Text textAlign="center" fontWeight={350} color={selectedIdx === 0 ? '#293033' : '#E0E0E0'} className="gradient_left_content" fontSize={['14px','14px','14px','14px','14px','16px']}>Previous Conversation</Text>
            </Box>
