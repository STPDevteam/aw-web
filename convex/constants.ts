...
export const COLLISION_THRESHOLD = 2.25;

// How many human players can be in a world at once.
export const MAX_HUMAN_PLAYERS = 100;

// Don't talk to anyone for 15000s after having a conversation.
export const CONVERSATION_COOLDOWN = 15000000;

// Don't do another activity for 10s after doing one.
export const ACTIVITY_COOLDOWN = 10_000;

// Don't talk to a player within 60000s of talking to them.
export const PLAYER_CONVERSATION_COOLDOWN = 60000000;
